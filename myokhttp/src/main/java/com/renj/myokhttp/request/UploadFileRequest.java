...
import com.renj.myokhttp.body.UploadRequestBody;
 ...
 * ======================================================================
 */
public class UploadFileRequest extends MyOkHttpRequest<UploadFileRequest> {
     ...
     */
    @Override
    protected <E> void putParams(Request.Builder builder, final MyOkHttpResponseHandler<E> mMyOkHttpResponseHandler) {
