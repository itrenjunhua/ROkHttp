...
public abstract class KeyValueRequest<T extends KeyValueRequest> extends MyOkHttpRequest<T> {
    ...
    protected <E> void putParams(Request.Builder builder, MyOkHttpResponseHandler<E> mMyOkHttpResponseHandler) {
        ...
        postParams(builder, mMyOkHttpResponseHandler);
    }
     ...
     */
    protected abstract <E> void postParams(Request.Builder builder, MyOkHttpResponseHandler<E> mMyOkHttpResponseHandler);
}
